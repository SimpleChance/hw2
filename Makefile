...
OBJS=amazon.o mydatastore.o user.o db_parser.o product.o product_parser.o book.o clothing.o movie.o util.o
...
clean:
	rm -f *.o *.gch amazon book clothing movie mydatastore